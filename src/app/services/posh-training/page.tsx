    ...
    <main className="w-full min-h-screen bg-[#0a0a0a] pt-32 pb-24 px-6 flex flex-col items-center overflow-hidden">
      ...
      <div className="max-w-6xl w-full mb-32">
        <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-[#0f0f0f] rounded-3xl p-10 md:p-14 border border-white/5 relative overflow-hidden"
        >
          ...
          <div className="flex flex-col md:flex-row gap-12 relative z-10">
            <div className="md:w-1/3">
              ...
              <h3 className="text-3xl font-serif text-white mb-4">Internal Complaints Committee [IC]</h3>
              <p className="text-gray-400 font-light mb-6">Training for Managers</p>
            </div>
