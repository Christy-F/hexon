...
export default function LDCPage() {
  ...
  return (
    <main className="w-full min-h-screen bg-[#0a0a0a] pt-32 pb-24 px-6 flex flex-col items-center overflow-hidden">
      ...
      <div className="max-w-6xl w-full mb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
          ...
          {phases.map((phase, index) => (
            ...
            >
              <div className="w-16 h-16 rounded-full bg-white/5 flex items-center justify-center mb-8 relative z-10">
                <div style={{ color: phase.color }}>{phase.icon}</div>
              </div>
              
              <h3 className="text-2xl font-serif text-white mb-4 relative z-10" style={{ color: phase.color }}>
                {phase.title}
              </h3>
      ...
      >
        <p className="text-2xl text-[var(--color-hexon-gold)] font-serif italic border-y border-white/10 py-10 px-6 leading-relaxed">
