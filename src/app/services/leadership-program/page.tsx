  ...
  return (
    <main className="w-full min-h-screen bg-white pt-32 pb-24 px-6 flex flex-col items-center overflow-hidden">
      ...
      <div className="max-w-4xl w-full mb-32 space-y-12">
        ...
        >
          <p className="text-2xl md:text-3xl text-[var(--color-hexon-gold)] font-serif italic border-y border-black/10 py-10 px-6 leading-relaxed">
      ...
      <div className="max-w-6xl w-full mb-32">
        <h3 className="text-3xl font-serif text-zinc-900 mb-12 text-center">Training Programs</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            <motion.div
              ...
              className="bg-gray-50 rounded-3xl p-10 border border-black/5 hover:border-black/20 transition-colors duration-300 relative overflow-hidden group"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-black/5 blur-[50px] rounded-full group-hover:bg-black/10 transition-colors"></div>
              <h3 className="text-xl font-serif text-zinc-900 mb-4 relative z-10" style={{ color: prog.color }}>{prog.title}</h3>
      ...
      <div className="max-w-4xl w-full mb-32 bg-gray-50 border border-black/5 rounded-3xl p-10 md:p-16">
        <h3 className="text-3xl font-serif text-zinc-900 mb-8 text-center">Strategic Impact</h3>
        <ul className="space-y-6">
          {[
            ...
            >
              ...
              <span className="text-gray-700 font-light text-lg">{item}</span>
            </motion.li>
          ))}
        </ul>
      </div>
