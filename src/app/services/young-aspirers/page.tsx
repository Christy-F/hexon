  ...
  return (
    <main className="w-full min-h-screen bg-[#0a0a0a] pt-32 pb-24 px-6 flex flex-col items-center overflow-hidden">
      ...
      <div className="max-w-4xl w-full mb-24 space-y-12">
        ...
        >
          <h3 className="text-2xl font-serif text-white mb-4">Our Methodology</h3>
      ...
      <div className="max-w-6xl w-full mb-32">
        <h3 className="text-3xl font-serif text-white mb-12 text-center">The topics covered during the training comprises…</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {topics.map((topic, index) => (
            <motion.div 
              ...
              className="bg-[#0f0f0f] rounded-2xl p-6 border border-white/5 hover:border-[var(--color-hexon-teal)]/40 transition-all duration-300 flex items-center gap-4 group"
            >
              ...
              <span className="text-gray-300 font-light text-sm md:text-base group-hover:text-white transition-colors">{topic}</span>
            </motion.div>
          ))}
        </div>
      </div>
