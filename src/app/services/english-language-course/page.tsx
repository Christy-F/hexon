  ...
  return (
    <main className="w-full min-h-screen bg-white pt-32 pb-24 px-6 flex flex-col items-center overflow-hidden">
      ...
      <div className="max-w-4xl w-full mb-24 space-y-12">
        ...
        >
          <h3 className="text-3xl font-serif text-zinc-900 mb-6">Why should we learn Spoken English?</h3>
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 mb-32">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-gray-50 rounded-3xl p-10 border border-black/5 relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-48 h-48 bg-[var(--color-hexon-teal)]/5 blur-[60px] rounded-full"></div>
          <h3 className="text-2xl font-serif text-zinc-900 mb-8 relative z-10 flex items-center gap-4">
        ...
        >
          ...
          <div className="space-y-6 relative z-10">
            <div className="group">
              <h4 className="text-zinc-900 text-lg font-medium mb-1 group-hover:text-[var(--color-hexon-gold)] transition-colors">Basic Level: <span className="font-light text-gray-600">(For beginners)</span></h4>
              <p className="text-gray-600 font-light leading-relaxed">Focus is on the basics of English – sentence structure, vocabulary and pronunciation.</p>
            </div>
            <div className="group">
              <h4 className="text-zinc-900 text-lg font-medium mb-1 group-hover:text-[var(--color-hexon-gold)] transition-colors">Intermediate Level: <span className="font-light text-gray-600">(For those who have a basic understanding of English)</span></h4>
              <p className="text-gray-600 font-light leading-relaxed">Focus is on improving fluency and accuracy.</p>
            </div>
            <div className="group">
              <h4 className="text-zinc-900 text-lg font-medium mb-1 group-hover:text-[var(--color-hexon-gold)] transition-colors">Advanced Level: <span className="font-light text-gray-600">(For those who have a good command over English)</span></h4>
              <p className="text-gray-600 font-light leading-relaxed">Focus is on fine-tuning pronunciation and building vocabulary.</p>
            </div>
          </div>
        </motion.div>
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 mb-32">
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-gray-50 rounded-3xl p-10 border border-black/10 hover:border-black/30 transition-colors group flex flex-col items-center text-center"
        >
          ...
          <h3 className="text-2xl font-serif text-zinc-900 mb-4">Customized Classes</h3>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ delay: 0.1 }}
          className="bg-gray-50 rounded-3xl p-10 border border-[var(--color-hexon-teal)]/20 hover:border-[var(--color-hexon-teal)]/50 transition-colors group flex flex-col items-center text-center"
        >
          ...
          <h3 className="text-2xl font-serif text-zinc-900 mb-4">Voice & Accent Training</h3>
          <p className="text-gray-600 font-light leading-relaxed">
