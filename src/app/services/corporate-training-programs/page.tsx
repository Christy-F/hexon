  ...
  return (
    <main className="w-full min-h-screen bg-white pt-32 pb-24 px-6 flex flex-col items-center overflow-hidden">
      ...
      <div className="max-w-4xl w-full mb-32 space-y-12">
        ...
        >
          <h3 className="text-3xl font-serif text-zinc-900 mb-6">Learning Interventions Offered</h3>
      ...
      <div className="max-w-6xl w-full mb-32">
        <h3 className="text-3xl font-serif text-zinc-900 mb-12 text-center">Delivery Modes</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <motion.div
              ...
              className="bg-gray-50 rounded-3xl p-8 border border-black/5 hover:border-[var(--color-hexon-teal)]/30 transition-colors duration-300 relative overflow-hidden group"
            >
              ...
              <h3 className="text-xl font-serif text-zinc-900 mb-3 relative z-10">{mode.title}</h3>
              <p className="text-gray-600 font-light text-sm leading-relaxed relative z-10">
                {mode.desc}
              </p>
            </motion.div>
          ))}
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 relative z-10">
          ...
          <button className="bg-transparent border border-white text-white px-8 py-4 rounded-full font-medium tracking-wide hover:bg-black/10 transition-all duration-300">
            Download Brochure
          </button>
        </div>
      </motion.div>
