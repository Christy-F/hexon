  ...
  return (
    <main className="w-full min-h-screen bg-white pt-32 pb-24 px-6 flex flex-col items-center overflow-hidden">
      ...
      <div className="max-w-6xl w-full mb-32">
        <h3 className="text-3xl font-serif text-zinc-900 mb-12 text-center">At Hexon we offer</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-gray-50 rounded-3xl p-10 border border-[var(--color-hexon-teal)]/20 hover:border-[var(--color-hexon-teal)]/50 transition-colors duration-300 group flex flex-col items-center text-center relative overflow-hidden"
          >
            ...
            <h3 className="text-2xl font-serif text-zinc-900 mb-4 relative z-10">1-1 Coaching</h3>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.1 }}
            className="bg-gray-50 rounded-3xl p-10 border border-[var(--color-hexon-gold)]/20 hover:border-[var(--color-hexon-gold)]/50 transition-colors duration-300 group flex flex-col items-center text-center relative overflow-hidden"
          >
            ...
            <h3 className="text-2xl font-serif text-zinc-900 mb-4 relative z-10">Group / Team Coaching</h3>
            <p className="text-gray-600 font-light leading-relaxed relative z-10">
