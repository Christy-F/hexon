...
export default async function AdminAppointmentsPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-zinc-900 pt-32 pb-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gray-50 border border-black/10 rounded-2xl overflow-hidden shadow-2xl">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-black/10 bg-black/5">
                  <th className="py-5 px-6 font-semibold text-gray-700">Client</th>
                  <th className="py-5 px-6 font-semibold text-gray-700">Contact Info</th>
                  <th className="py-5 px-6 font-semibold text-gray-700">Service Requested</th>
                  <th className="py-5 px-6 font-semibold text-gray-700">Preferred Date</th>
                  <th className="py-5 px-6 font-semibold text-gray-700">Submitted</th>
                </tr>
              </thead>
                ...
                {appointments.length === 0 ? (
                  ...
                  appointments.map((apt) => (
                    <tr key={apt.id} className="hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="py-5 px-6">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/5 border border-black/10 text-sm text-gray-700">
