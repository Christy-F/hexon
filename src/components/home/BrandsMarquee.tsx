...
export default function BrandsMarquee() {
  return (
    <section className="relative w-full py-20 bg-white border-t border-black/5 overflow-hidden flex flex-col items-center">
      ...
      <div className="w-full flex overflow-hidden relative">
        ...
        >
          ...
          {[...brands, ...brands].map((brand, idx) => (
            <div key={idx} className="flex items-center justify-center opacity-80 hover:opacity-100 transition-opacity duration-300 cursor-pointer">
              <span className="text-2xl md:text-3xl font-serif text-zinc-900 tracking-wide hover:text-4xl">
                {brand}
              </span>
            </div>
          ))}
