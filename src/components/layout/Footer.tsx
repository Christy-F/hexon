...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full bg-gray-50 text-zinc-900 pt-32 pb-0 overflow-hidden border-t border-black/5">
      {/* Background Glows */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        {/* HUGE CTA SECTION */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-24 gap-12 border-b border-black/10 pb-16">
          ...
          >
            <a
              ...
              className="inline-flex items-center justify-center w-40 h-40 rounded-full bg-[var(--color-hexon-teal)] hover:bg-white hover:text-[var(--color-hexon-teal)] text-zinc-900 font-medium text-lg transition-all duration-500 hover:scale-105 hover:shadow-[0_0_40px_rgba(0,173,179,0.4)]"
            >
              Get in touch
            </a>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20 bg-[#00ADB3] p-10 md:p-16 rounded-[2rem] shadow-2xl">
          ...
          <div className="md:col-span-4 lg:col-span-5 pr-0 md:pr-12">
            ...
            <p className="text-zinc-900/90 text-sm leading-relaxed mb-8 max-w-sm">
            ...
            <div className="flex gap-4">
              {[
                ...
                <a key={idx} href={social.href} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-black/20 bg-black/10 flex items-center justify-center hover:bg-white hover:text-[#00ADB3] hover:border-transparent hover:scale-110 transition-all duration-300">
          ...
          <div className="md:col-span-8 lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              <h4 className="text-zinc-900 font-medium mb-8 text-lg">Company</h4>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={idx}>
                    <Link href={item.href} className="text-zinc-900/80 hover:text-zinc-900 transition-colors text-sm group flex items-center">
            ...
            <div>
              <h4 className="text-zinc-900 font-medium mb-8 text-lg">Expertise</h4>
              <ul className="space-y-4">
                {[
            ...
            <div className="col-span-2 md:col-span-1">
              <h4 className="text-zinc-900 font-medium mb-8 text-lg">Get in Touch</h4>
              <div className="space-y-4 text-sm text-zinc-900/90">
                <p className="flex flex-col">
                  <span className="text-zinc-900/60 mb-1">Phone</span>
                  <a href="tel:+917550553355" className="text-zinc-900 hover:opacity-75 transition-opacity text-base">+91 7550553355</a>
                </p>
                <p className="flex flex-col">
                  <span className="text-zinc-900/60 mb-1">Email</span>
                  <a href="mailto:contact@hexonindia.in" className="text-zinc-900 hover:opacity-75 transition-opacity text-base">contact@hexonindia.in</a>
                </p>
              </div>
            </div>
          </div>
